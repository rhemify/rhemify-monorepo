...
const MOCK_BALANCES: WalletBalance[] = [
  { id: 'bal-1', dwalletId: 'ika-dw-treasury-001', chain: 'base', token: 'USDC', amount: 25420.50, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-2', dwalletId: 'ika-dw-treasury-001', chain: 'base', token: 'ETH', amount: 2.847, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-3', dwalletId: 'ika-dw-treasury-001', chain: 'ethereum', token: 'USDC', amount: 12000.00, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-4', dwalletId: 'ika-dw-treasury-001', chain: 'arbitrum', token: 'USDC', amount: 8350.25, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-5', dwalletId: 'ika-dw-ceo-001', chain: 'base', token: 'USDC', amount: 4200.00, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-6', dwalletId: 'ika-dw-ceo-001', chain: 'ethereum', token: 'USDC', amount: 1500.00, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-7', dwalletId: 'ika-dw-research-001', chain: 'base', token: 'USDC', amount: 890.75, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-8', dwalletId: 'ika-dw-ops-001', chain: 'base', token: 'USDC', amount: 320.00, lastSyncedAt: Date.now() - 30000 },
  { id: 'bal-9', dwalletId: 'ika-dw-ops-001', chain: 'arbitrum', token: 'USDC', amount: 150.00, lastSyncedAt: Date.now() - 30000 },
]
...
export class MockWalletService implements WalletService {
  ...
  getAllBalances(fleetId: string): WalletBalance[] {
    const walletIds = this.wallets
      .filter(w => w.fleetId === fleetId)
      .map(w => w.dwalletId)
